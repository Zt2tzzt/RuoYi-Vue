...
在新建的子模块的 pom.xml 文件中，引入若依的核心模块 ruoyi-framework
...
新增、修改、删除涉及岛两张表的操作，分别是菜品表、口味表。它们的关系是一对多。
...
- 阿里云 OSS 上的图片，通常时一个完整的图片路径，包含“http”
